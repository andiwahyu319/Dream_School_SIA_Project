        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <ul class="nav nav-pills flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{url('quiz') . '/' . $quiz->id . '/q/edit'}}"><i class="fas fa-edit"></i> Add Question</a>
                    </li>
            ...
            <form action="" method="post">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="question" class="form-control @error('question') is-invalid @enderror" id="question" placeholder="Enter Question" required></textarea>
                        @error('question')
                        ...
                        <div class="col col-md-6">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="option_a" class="form-control @error('option_a') is-invalid @enderror" id="option_a" placeholder="Enter Option A" onchange="updateTrueOption('a', value)" required>
                                </div>
                                @error('option_a')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="option_b" class="form-control @error('option_b') is-invalid @enderror" id="option_b" placeholder="Enter Option B" onchange="updateTrueOption('b', value)" required>
                                </div>
                                @error('option_b')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="col col-md-6">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="option_c" class="form-control @error('option_c') is-invalid @enderror" id="option_c" placeholder="Enter Option C" onchange="updateTrueOption('c', value)" required>
                                </div>
                                @error('option_c')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="option_d" class="form-control @error('option_d') is-invalid @enderror" id="option_d" placeholder="Enter Option D" onchange="updateTrueOption('d', value)" required>
                                </div>
                                @error('option_d')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-info btn-icon-split btn-block">
                        ...
                        <span class="text btn-block">Add Question</span>
                    </button>
                </div> 
            </form>
        </div>
